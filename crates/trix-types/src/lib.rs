...
pub use api::{
    ...
    LeaveChatRequest, LeaveChatResponse, LeaveChatScope, MessageEnvelope, ModifyChatDevicesRequest,
    ...
    RequestHistorySyncRepairResponse, ReserveKeyPackagesRequest, ReservedKeyPackage,
